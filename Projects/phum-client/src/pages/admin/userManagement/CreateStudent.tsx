...
import TPHDatePicker from "../../../components/form/PHDatePicker";
      ...
      <Col span={24}>
        <PHFrom onSubmit={onSubmit} defaultValues={studentDefaultValues}>
          ...
          <Row gutter={8}>
            ...
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
              <PHSelect name="gender" options={gendersOptions} label="Gender" />
            </Col>
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
              <TPHDatePicker name="dateOfBirth" label="Date of Birth" />
            </Col>
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
              <PHSelect
                name="bloogGroup"
